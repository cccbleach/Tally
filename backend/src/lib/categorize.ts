...
const EXPENSE_RULES: Rule[] = [
  ...
  { pattern: /美团|meituan|饿了么|eleme|外卖|盒马|海底捞|肯德基|麦当劳|星巴克|必胜客|蜜雪|奈雪|餐|饮|食|咖啡|奶茶|可乐|零食|小吃|菜|莓|水果|净菜|鲜|面|饭|味/i, category: "餐饮" },
  ...
  { pattern: /转账汇款|微信转账|支付宝转账|取现|结售汇|付汇|收款|经营码|待收款|报销|保单|保险|还款|信贷|服务器|invoice|宽带|房租|物业|水电|燃气|火山引擎|腾讯云|阿里云|云服务|云计算/i, category: "其他支出" },
];
